...
import { CentroidAnimationEngine } from './animation-engine-centroid-v2.js?v=7';
...
class TimelineCentroidApp {
    ...
    fitCamera() {
        // Distance to see the normalized spread layout
        // Clusters spread across ±150 X, ±100 Y, ±50 Z
